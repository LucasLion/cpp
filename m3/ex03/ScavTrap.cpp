...
/*   Updated: 2023/07/16 16:30:07 by llion@student    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack( const std::string& target ) {
	if (this->getEnergy() > 0 && this->getHealth() > 0) {
		...
		std::cout << "ScavTrap " << this->getName() << " tries to attack but " << this->getName() << " is \033[31mout of energy \033[0m" << std::endl;
}
